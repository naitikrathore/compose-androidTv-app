...
object LanguageCodeMapper {
    ...
    var languageCodes = mutableListOf<LanguageCode>()
    var preferredLanguageCodes = mutableListOf<LanguageCode>()

    var countryCodeToLanguageCodeMap = mutableMapOf<String, String?>()
    var countryCodeToTxtDigitalLanguageMap = mutableMapOf<String, Int>()
    var countryCodeToTxtDecodeLanguageMap = mutableMapOf<String, Int>()
    var ttxPositionToDigitalLanguageMap = mutableMapOf<Int, Int>()
    var ttxPositionToDecodeLanguageMap = mutableMapOf<Int, Int>()
    ...
    init {
        ...
        preferredLanguageCodes.add(LanguageCode("bel", "be", "Belarusian", "biélorusse", "Weißrussisch"))
        ...
        preferredLanguageCodes.add(LanguageCode("lit", "lt", "Lithuanian", "lituanien", "Litauisch"))
        preferredLanguageCodes.add(LanguageCode("mkd", "mk", "Macedonian", "macédonien", "Makedonisch"))
        preferredLanguageCodes.add(
            LanguageCode(
                "nno",
                "nn",
        ...
        preferredLanguageCodes.add(LanguageCode("por", "pt", "Portuguese", "portugais", "Portugiesisch"))
        preferredLanguageCodes.add(
            LanguageCode(
                "ron",
                "ro",
...
//    constructor() {
        ...
        languageCodes.add(LanguageCode("eng", "en", "English", "anglais", "Englisch"))
        languageCodes.add(
            LanguageCode(
                "enm",
                "",
