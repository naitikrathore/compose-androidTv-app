...
import com.iwedia.cltv.sdk.content_provider.ReferenceContract.Channels
import com.iwedia.cltv.sdk.content_provider.ReferenceContract.Config
import com.iwedia.cltv.sdk.content_provider.ReferenceContract.OemCustomization
import com.iwedia.cltv.sdk.content_provider.ReferenceContract.Favorites
import java.lang.IllegalArgumentException

class ReferenceContentProvider : ContentProvider() {

    private var db: SQLiteDatabase? = null


    companion object {
        val AUTHORITY = "com.iwedia.cltv.platform.model.content_provider.ReferenceContentProvider"
    ...
    init {
        ...
        OEM_CUSTOMIZATION_PROJECTION_MAP.put(
            OemCustomization.TIMESHIFT_ENABLED_COLUMN,
            OEM_CUSTOMIZATION_TABLE + "." + OemCustomization.TIMESHIFT_ENABLED_COLUMN
        )

        LANGUAGES_PROJECTION_MAP.put(BaseColumns._ID, LANGUAGES_TABLE + "." + BaseColumns._ID)
        LANGUAGES_PROJECTION_MAP.put(
            ReferenceContract.Languages.LANGUAGE_CODE_COLUMN,
            LANGUAGES_TABLE + "." + ReferenceContract.Languages.LANGUAGE_CODE_COLUMN
        )
        LANGUAGES_PROJECTION_MAP.put(
            ReferenceContract.Languages.LANGUAGE_CONTENT_COLUMN,
            LANGUAGES_TABLE + "." + ReferenceContract.Languages.LANGUAGE_CONTENT_COLUMN
        )
        ...
        SCHEDULED_REMINDERS_PROJECTION_MAP.put(
            ...
            SCHEDULED_REMINDERS_TABLE + "." + ReferenceContract.ScheduledReminders.NAME_COLUMN
        )
        SCHEDULED_REMINDERS_PROJECTION_MAP.put(
            ReferenceContract.ScheduledReminders.CHANNEL_ID_COLUMN,
            SCHEDULED_REMINDERS_TABLE + "." + ReferenceContract.ScheduledReminders.CHANNEL_ID_COLUMN
        )
        SCHEDULED_REMINDERS_PROJECTION_MAP.put(
            ReferenceContract.ScheduledReminders.EVENT_ID_COLUMN,
            SCHEDULED_REMINDERS_TABLE + "." + ReferenceContract.ScheduledReminders.EVENT_ID_COLUMN
        )
        SCHEDULED_REMINDERS_PROJECTION_MAP.put(
            ReferenceContract.ScheduledReminders.START_TIME_COLUMN,
            SCHEDULED_REMINDERS_TABLE + "." + ReferenceContract.ScheduledReminders.START_TIME_COLUMN
        )
        ...
        SCHEDULED_RECORDINGS_PROJECTION_MAP.put(
            ...
            SCHEDULED_RECORDINGS_TABLE + "." + ReferenceContract.ScheduledRecordings.NAME_COLUMN
        )
        SCHEDULED_RECORDINGS_PROJECTION_MAP.put(
            ReferenceContract.ScheduledRecordings.CHANNEL_ID_COLUMN,
            SCHEDULED_RECORDINGS_TABLE + "." + ReferenceContract.ScheduledRecordings.CHANNEL_ID_COLUMN
        )
        SCHEDULED_RECORDINGS_PROJECTION_MAP.put(
            ReferenceContract.ScheduledRecordings.TV_EVENT_ID_COLUMN,
            SCHEDULED_RECORDINGS_TABLE + "." + ReferenceContract.ScheduledRecordings.TV_EVENT_ID_COLUMN
        )
        SCHEDULED_RECORDINGS_PROJECTION_MAP.put(
            ReferenceContract.ScheduledRecordings.START_TIME_COLUMN,
            SCHEDULED_RECORDINGS_TABLE + "." + ReferenceContract.ScheduledRecordings.START_TIME_COLUMN
        )
        SCHEDULED_RECORDINGS_PROJECTION_MAP.put(
            ReferenceContract.ScheduledRecordings.END_TIME_COLUMN,
            SCHEDULED_RECORDINGS_TABLE + "." + ReferenceContract.ScheduledRecordings.END_TIME_COLUMN
        )
        SCHEDULED_RECORDINGS_PROJECTION_MAP.put(
            ReferenceContract.ScheduledRecordings.DATA_COLUMN,
            SCHEDULED_RECORDINGS_TABLE + "." + ReferenceContract.ScheduledRecordings.DATA_COLUMN
        )
        ...
        CONFIGURABLE_KEYS_PROJECTION_MAP.put(
            ReferenceContract.ConfigurableKeys.KEY_NAME_COLUMN,
            CONFIGURABLE_KEYS_TABLE + "." + ReferenceContract.ConfigurableKeys.KEY_NAME_COLUMN
        )
        CONFIGURABLE_KEYS_PROJECTION_MAP.put(
            ReferenceContract.ConfigurableKeys.KEY_ACTION_TYPE_COLUMN,
            CONFIGURABLE_KEYS_TABLE + "." + ReferenceContract.ConfigurableKeys.KEY_ACTION_TYPE_COLUMN
        )
        CONFIGURABLE_KEYS_PROJECTION_MAP.put(
            ReferenceContract.ConfigurableKeys.KEY_DESCRIPTION_COLUMN,
            CONFIGURABLE_KEYS_TABLE + "." + ReferenceContract.ConfigurableKeys.KEY_DESCRIPTION_COLUMN
        )
        ...
        SYSTEM_INFO_PROJECTION_MAP.put(ReferenceContract.SystemInfo.RF_CHANNEL_NUMBER_ENABLED_COLUMN, SYSTEM_INFO_TABLE + "." + ReferenceContract.SystemInfo.RF_CHANNEL_NUMBER_ENABLED_COLUMN)
        SYSTEM_INFO_PROJECTION_MAP.put(ReferenceContract.SystemInfo.BER_ENABLED_COLUMN, SYSTEM_INFO_TABLE + "." + ReferenceContract.SystemInfo.BER_ENABLED_COLUMN)
        SYSTEM_INFO_PROJECTION_MAP.put(ReferenceContract.SystemInfo.FREQUENCY_ENABLED_COLUMN, SYSTEM_INFO_TABLE + "." + ReferenceContract.SystemInfo.FREQUENCY_ENABLED_COLUMN)
        SYSTEM_INFO_PROJECTION_MAP.put(ReferenceContract.SystemInfo.PROG_ENABLED_COLUMN, SYSTEM_INFO_TABLE + "." + ReferenceContract.SystemInfo.PROG_ENABLED_COLUMN)
        SYSTEM_INFO_PROJECTION_MAP.put(ReferenceContract.SystemInfo.UEC_ENABLED_COLUMN, SYSTEM_INFO_TABLE + "." + ReferenceContract.SystemInfo.UEC_ENABLED_COLUMN)
        SYSTEM_INFO_PROJECTION_MAP.put(ReferenceContract.SystemInfo.SERVICEID_ENABLED_COLUMN, SYSTEM_INFO_TABLE + "." + ReferenceContract.SystemInfo.SERVICEID_ENABLED_COLUMN)
        SYSTEM_INFO_PROJECTION_MAP.put(ReferenceContract.SystemInfo.POSTVITERBI_ENABLED_COLUMN, SYSTEM_INFO_TABLE + "." + ReferenceContract.SystemInfo.POSTVITERBI_ENABLED_COLUMN)
        SYSTEM_INFO_PROJECTION_MAP.put(ReferenceContract.SystemInfo.TSID_ENABLED_COLUMN, SYSTEM_INFO_TABLE + "." + ReferenceContract.SystemInfo.TSID_ENABLED_COLUMN)
        SYSTEM_INFO_PROJECTION_MAP.put(ReferenceContract.SystemInfo.FIVES_ENABLED_COLUMN, SYSTEM_INFO_TABLE + "." + ReferenceContract.SystemInfo.FIVES_ENABLED_COLUMN)
        SYSTEM_INFO_PROJECTION_MAP.put(ReferenceContract.SystemInfo.ONID_ENABLED_COLUMN, SYSTEM_INFO_TABLE + "." + ReferenceContract.SystemInfo.ONID_ENABLED_COLUMN)
        SYSTEM_INFO_PROJECTION_MAP.put(ReferenceContract.SystemInfo.AGC_ENABLED_COLUMN, SYSTEM_INFO_TABLE + "." + ReferenceContract.SystemInfo.AGC_ENABLED_COLUMN)
        SYSTEM_INFO_PROJECTION_MAP.put(ReferenceContract.SystemInfo.NETWORKID_ENABLED_COLUMN, SYSTEM_INFO_TABLE + "." + ReferenceContract.SystemInfo.NETWORKID_ENABLED_COLUMN)
        SYSTEM_INFO_PROJECTION_MAP.put(ReferenceContract.SystemInfo.NETWORKNAME_ENABLED_COLUMN, SYSTEM_INFO_TABLE + "." + ReferenceContract.SystemInfo.NETWORKNAME_ENABLED_COLUMN)
        SYSTEM_INFO_PROJECTION_MAP.put(ReferenceContract.SystemInfo.BANDWIDTH_ENABLED_COLUMN, SYSTEM_INFO_TABLE + "." + ReferenceContract.SystemInfo.BANDWIDTH_ENABLED_COLUMN)
    }
    ...
    private class DBHelper(context: Context) :
        ...
        override fun onCreate(p0: SQLiteDatabase?) {
            ...
            p0.execSQL("CREATE TABLE $LANGUAGES_TABLE ("
                    + BaseColumns._ID + " INTEGER PRIMARY KEY AUTOINCREMENT,"
                    + ReferenceContract.Languages.LANGUAGE_CODE_COLUMN + " TEXT,"
                    + ReferenceContract.Languages.LANGUAGE_CONTENT_COLUMN + " TEXT,"
                    + "UNIQUE(${BaseColumns._ID})"
                    +");")
            // Create scheduled reminders table
            p0.execSQL("CREATE TABLE $SCHEDULED_REMINDERS_TABLE ("
                    + BaseColumns._ID + " INTEGER PRIMARY KEY AUTOINCREMENT,"
                    + ReferenceContract.ScheduledReminders.NAME_COLUMN + " TEXT,"
                    + ReferenceContract.ScheduledReminders.CHANNEL_ID_COLUMN + " INTEGER NOT NULL DEFAULT 0,"
                    + ReferenceContract.ScheduledReminders.EVENT_ID_COLUMN + " INTEGER NOT NULL DEFAULT 0,"
                    + ReferenceContract.ScheduledReminders.START_TIME_COLUMN + " LONG NOT NULL DEFAULT 0,"
                    + "UNIQUE(${BaseColumns._ID})"
                    +");")
            // Create scheduled recordings table
            p0.execSQL("CREATE TABLE $SCHEDULED_RECORDINGS_TABLE ("
                    + BaseColumns._ID + " INTEGER PRIMARY KEY AUTOINCREMENT,"
                    + ReferenceContract.ScheduledRecordings.NAME_COLUMN + " TEXT,"
                    + ReferenceContract.ScheduledRecordings.CHANNEL_ID_COLUMN + " INTEGER NOT NULL DEFAULT 0,"
                    + ReferenceContract.ScheduledRecordings.TV_EVENT_ID_COLUMN + " INTEGER NOT NULL DEFAULT 0,"
                    + ReferenceContract.ScheduledRecordings.START_TIME_COLUMN + " LONG NOT NULL DEFAULT 0,"
                    + ReferenceContract.ScheduledRecordings.END_TIME_COLUMN + " LONG NOT NULL DEFAULT 0,"
                    + ReferenceContract.ScheduledRecordings.DATA_COLUMN + " TEXT,"
                    + "UNIQUE(${BaseColumns._ID})"
                    +");")
            ...
            p0.execSQL(
                "CREATE TABLE $CONFIGURABLE_KEYS_TABLE ("
                        + BaseColumns._ID + " INTEGER PRIMARY KEY AUTOINCREMENT,"
                        + ReferenceContract.ConfigurableKeys.KEY_NAME_COLUMN + " TEXT,"
                        + ReferenceContract.ConfigurableKeys.KEY_ACTION_TYPE_COLUMN + " INTEGER NOT NULL DEFAULT 0,"
                        + ReferenceContract.ConfigurableKeys.KEY_DESCRIPTION_COLUMN + " INTEGER NOT NULL DEFAULT 0,"
                        + "UNIQUE(${BaseColumns._ID})"
                        + ");"
            )
            ...
            p0.execSQL(
                "CREATE TABLE $SYSTEM_INFO_TABLE ("
                        + BaseColumns._ID + " INTEGER PRIMARY KEY AUTOINCREMENT,"
                        + ReferenceContract.SystemInfo.RF_CHANNEL_NUMBER_ENABLED_COLUMN + " INTEGER NOT NULL DEFAULT 1,"
                        + ReferenceContract.SystemInfo.BER_ENABLED_COLUMN + " INTEGER NOT NULL DEFAULT 1,"
                        + ReferenceContract.SystemInfo.FREQUENCY_ENABLED_COLUMN + " INTEGER NOT NULL DEFAULT 1,"
                        + ReferenceContract.SystemInfo.PROG_ENABLED_COLUMN + " INTEGER NOT NULL DEFAULT 1,"
                        + ReferenceContract.SystemInfo.UEC_ENABLED_COLUMN + " INTEGER NOT NULL DEFAULT 1,"
                        + ReferenceContract.SystemInfo.SERVICEID_ENABLED_COLUMN + " INTEGER NOT NULL DEFAULT 1,"
                        + ReferenceContract.SystemInfo.POSTVITERBI_ENABLED_COLUMN + " INTEGER NOT NULL DEFAULT 1,"
                        + ReferenceContract.SystemInfo.TSID_ENABLED_COLUMN + " INTEGER NOT NULL DEFAULT 1,"
                        + ReferenceContract.SystemInfo.FIVES_ENABLED_COLUMN + " INTEGER NOT NULL DEFAULT 1,"
                        + ReferenceContract.SystemInfo.ONID_ENABLED_COLUMN + " INTEGER NOT NULL DEFAULT 1,"
                        + ReferenceContract.SystemInfo.AGC_ENABLED_COLUMN + " INTEGER NOT NULL DEFAULT 1,"
                        + ReferenceContract.SystemInfo.NETWORKID_ENABLED_COLUMN + " INTEGER NOT NULL DEFAULT 1,"
                        + ReferenceContract.SystemInfo.NETWORKNAME_ENABLED_COLUMN + " INTEGER NOT NULL DEFAULT 1,"
                        + ReferenceContract.SystemInfo.BANDWIDTH_ENABLED_COLUMN + " INTEGER NOT NULL DEFAULT 1,"
                        + "UNIQUE(${BaseColumns._ID})"
                        + ");"
            )
        }
        ...
        override fun onUpgrade(p0: SQLiteDatabase?, p1: Int, p2: Int) {
            ...
            if (p1 <= 11) {
                ...
                p0!!.execSQL("ALTER TABLE $CHANNELS_TABLE ADD ${ReferenceContract.Channels.INTERNAL_PROVIDER_FLAG1_COLUMN} INTEGER;")
            }
            if (p1 <= 12) {
                p0!!.execSQL(
                    "CREATE TABLE $SCHEDULED_REMINDERS_TABLE ("
                            ...
                            + ReferenceContract.ScheduledReminders.CHANNEL_ID_COLUMN + " INTEGER NOT NULL DEFAULT 0,"
                            + ReferenceContract.ScheduledReminders.EVENT_ID_COLUMN + " INTEGER NOT NULL DEFAULT 0,"
                            + ReferenceContract.ScheduledReminders.START_TIME_COLUMN + " INTEGER NOT NULL DEFAULT 0,"
                            + "UNIQUE(${BaseColumns._ID})"
                            + ");"
                )
            }
            ...
            if (p1 <= 16) {
                ...
                p0!!.execSQL("ALTER TABLE $CHANNELS_TABLE ADD ${ReferenceContract.Channels.DELETED_COLUMN} INTEGER DEFAULT 0;")
            }
            if (p1 <= 17) {
    ...
    override fun getType(uri: Uri): String? {
        when (sUriMatcher.match(uri)) {
            ...
            LANGUAGES -> return ReferenceContract.Languages.CONTENT_TYPE
            LANGUAGES_ID -> return ReferenceContract.Languages.CONTENT_ITEM_TYPE
            SCHEDULED_REMINDERS -> return ReferenceContract.ScheduledReminders.CONTENT_TYPE
            SCHEDULED_REMINDERS_ID -> return ReferenceContract.ScheduledReminders.CONTENT_ITEM_TYPE
            SCHEDULED_RECORDINGS -> return ReferenceContract.ScheduledRecordings.CONTENT_TYPE
            SCHEDULED_RECORDINGS_ID -> return ReferenceContract.ScheduledRecordings.CONTENT_ITEM_TYPE
            FAVORITES -> return Favorites.CONTENT_TYPE
            FAVORITES_ID -> return Favorites.CONTENT_ITEM_TYPE
            SYSTEM_INFO -> return ReferenceContract.SystemInfo.CONTENT_ITEM_TYPE
            SYSTEM_INFO_ID -> return ReferenceContract.SystemInfo.CONTENT_ITEM_TYPE
            else -> throw IllegalArgumentException("Unknown URI + $uri")
        }
    }
    ...
    fun insertChannel(uri: Uri, values: ContentValues): Uri {
        ...
        if (rowId > 0) {
            val channelUri: Uri = ReferenceContract.buildChannelsUri(rowId)
            return channelUri
        }
    ...
    fun insertConfig(uri: Uri, values: ContentValues): Uri {
        ...
        if (rowId > 0) {
            val configUri: Uri = ReferenceContract.buildConfigUri(rowId)
            return configUri
        } else {
            throw  SQLException("Failed to insert row into $uri")
        }
    ...
    fun insertOemCustomization(uri: Uri, values: ContentValues): Uri {
        ...
        if (rowId > 0) {
            val configUri: Uri = ReferenceContract.buildOemCustomizationUri(rowId)
            return configUri
        } else {
            throw  SQLException("Failed to insert row into $uri")
        }
    ...
    fun insertLanguages(uri: Uri, values: ContentValues): Uri {
        ...
        if (rowId > 0) {
            val configUri: Uri = ReferenceContract.buildLanguagesUri(rowId)
            return configUri
        } else {
            throw  SQLException("Failed to insert row into $uri")
        }
    ...
    fun insertScheduledReminder(uri: Uri, values: ContentValues): Uri {
        ...
        if (rowId > 0) {
            val configUri: Uri = ReferenceContract.buildScheduledRemindersUri(rowId)
            return configUri
        } else {
            throw  SQLException("Failed to insert row into $uri")
        }
    ...
    fun insertScheduledRecording(uri: Uri, values: ContentValues): Uri {
        ...
        if (rowId > 0) {
            val configUri: Uri = ReferenceContract.buildScheduledRecordingsUri(rowId)
            return configUri
        } else {
            throw  SQLException("Failed to insert row into $uri")
        }
    ...
    fun insertConfigurableKey(uri: Uri, values: ContentValues): Uri {
        ...
        if (rowId > 0) {
            val configUri: Uri = ReferenceContract.buildConfigurableKeysUri(rowId)
            return configUri
        } else {
            throw  SQLException("Failed to insert row into $uri")
        }
    ...
    fun insertFavorite(uri: Uri, values: ContentValues): Uri {
        ...
        if (rowId > 0) {
            val favoriteUri: Uri = ReferenceContract.buildFavoritesUri(rowId)
            return favoriteUri
        } else {
    ...
    fun insertSystemInformation(uri: Uri, values: ContentValues): Uri {
        ...
        if (rowId > 0) {
            val systemInfroUri: Uri = ReferenceContract.buildSystemInfoUri(rowId)
