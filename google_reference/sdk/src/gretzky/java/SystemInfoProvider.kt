...
import com.iwedia.cltv.sdk.ReferenceSdk.TAG
                                ...
                                if (cursor.getBlob(cursor.getColumnIndex(TvContract.Channels.COLUMN_INTERNAL_PROVIDER_DATA)) != null) {
                                    ...
                                    try {
                                        ...
                                        if (blob.isNotEmpty()) {
                                            ...
                                            android.util.Log.d(Constants.LogTag.CLTV_TAG + TAG, "getSystemInfoData: $providerData")
                                        ...
                                        android.util.Log.d(Constants.LogTag.CLTV_TAG + TAG, "getSystemInfoData: $ex")
                                    }
                    ...
                    channelsCursor.apply {
                        ...
                        while (moveToNext()) {
                            ...
                            if (type == "TERRESTRIAL" || type == "TERRESTRIAL_2" || type == "CABLE" || type == "SATELLITE)") {
                                ...
                                android.util.Log.d(Constants.LogTag.CLTV_TAG + TAG, "getSystemInfoData: ${jsonParameters.has("frequency")}")
