 ...
 * </table>
 */
public final class TvContentRating implements Parcelable {
    ...
    public String getmRatingSystem() {
        return mRatingSystem;
    }

    public void setmRatingSystem(String mRatingSystem) {
        this.mRatingSystem = mRatingSystem;
    }
    ...
    public String[] getmSubRatings() {
        return mSubRatings;
    }

    public void setmSubRatings(String[] mSubRatings) {
        this.mSubRatings = mSubRatings;
    }
    ...
    public TvContentRating(String mDomain, String mRatingSystem, String mRating, String[] mSubRatings, int mHashCode) {
        this.mDomain = mDomain;
        this.mRatingSystem = mRatingSystem;
        this.mRating = mRating;
        this.mSubRatings = mSubRatings;
    ...
    protected TvContentRating(Parcel in) {
        mDomain = in.readString();
        mRatingSystem = in.readString();
        mRating = in.readString();
        mSubRatings = in.createStringArray();
     ...
     *
     * @param rating The {@link android.media.tv.TvContentRating} to check.
    ...
    public void writeToParcel(@NonNull Parcel dest, int flags) {
        ...
        dest.writeString(mRatingSystem);
        dest.writeString(mRating);
        dest.writeStringArray(mSubRatings);
        dest.writeInt(mHashCode);
    }

    public static final Creator<TvContentRating> CREATOR = new Creator<TvContentRating>() {
        @Override
        public TvContentRating createFromParcel(Parcel in) {
            return new TvContentRating(in);
        }

        @Override
        public TvContentRating[] newArray(int size) {
            return new TvContentRating[size];
        }
    };
}
