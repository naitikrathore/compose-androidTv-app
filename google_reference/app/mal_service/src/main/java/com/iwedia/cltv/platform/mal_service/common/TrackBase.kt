...
sealed class TrackBase(val trackInfo: TvTrackInfo) : ITrack {
    ...
    class AudioTrack(
        val track: TvTrackInfo, val utilsInterface: UtilsInterface,
    ...
    class SubtitleTrack(val track: TvTrackInfo, val utilsInterface: UtilsInterface) :
        TrackBase(track), ISubtitle {
        override var languageName: String = getTrackLanguageName()
    ...
    fun getLanguageCodeMapper(language: String, utilsInterface: UtilsInterface): String {
        return utilsInterface.getLanguageMapper()!!.getLanguageName(language)
            ?: undefinedString
    }
}