...
fun createDummyServiceForRecording(inputId : String) : TvChannel {
    return TvChannel(
        id = 0,
        index = 0,
...
@SuppressLint("Range")
fun createRecordingsFromCursor(cursor: Cursor, tvModule: TvInterface, timeInterface: TimeInterface): Recording? {
    var recordingId = -1
    var recordingName = ""
