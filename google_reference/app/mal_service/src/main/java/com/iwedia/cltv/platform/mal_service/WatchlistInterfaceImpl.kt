...
class WatchlistInterfaceImpl(
    ...
    override fun scheduleReminder(
        ...
        val timeBeforeStartProgramme: Long =
            formattedStartTime.time - serviceImpl.getCurrentTimeByChannel(toServiceChannel(reminder.tvChannel!!)) - timeBeforeProgrammeStarts
    ...
    override fun removeWatchlistEventsForDeletedChannels() {
        CoroutineHelper.runCoroutine({
            ...
            val tempWatchList = mutableListOf<ScheduledReminder>()
    ...
    private fun recreateStoredReminder(reminder: ScheduledReminder) {
        ...
        val currentTime =
            serviceImpl.getCurrentTimeByChannel(tvChannel?.let { toServiceChannel(it) })
