package com.iwedia.cltv.scene.home_scene.recordings.rename_recording
 ...
 * @author Dejan Nadj
 */
class RenameRecordingScene (context: Context, sceneListener: SceneListener) :  ReferenceScene(
    context,
    ReferenceWorldHandler.SceneId.RENAME_RECORDING_SCENE,
    ReferenceWorldHandler.getSceneName(ReferenceWorldHandler.SceneId.RENAME_RECORDING_SCENE),
    sceneListener
){
    ...
    override fun createView() {
        super.createView()
        view = GAndroidSceneFragment(name, R.layout.rename_recording_scene_layout, object :
    ...
    private fun findRefs() {
        view!!.findViewById<ConstraintLayout>(R.id.background_layout).setBackgroundColor(Color.parseColor(ConfigColorManager.getColor("color_background")))
        title = view!!.findViewById(R.id.title)
        title.setText(ConfigStringsManager.getStringById("rename_recording"))
    ...
    private fun init() {
        ...
        editText.setOnEditorActionListener(TextView.OnEditorActionListener { v, actionId, event ->
            if (actionId == EditorInfo.IME_ACTION_GO) {
                ...
                (sceneListener as RenameRecordingSceneListener).onEnterPressed(editText.text.toString())
