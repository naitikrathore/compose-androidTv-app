package com.iwedia.cltv.platform.refplus5.parser;
...
public class ContentRatingsParser {
    ...
    public List<ContentRatingSystem> parse(TvContentRatingSystemInfo info) {
        ...
        try {
            ...
            Log.d(Constants.LogTag.CLTV_TAG + TAG, " packageName="+packageName +",curPackageName="+curPackageName);
            if(TextUtils.equals(packageName,curPackageName) && mRatingSystems != null){
                Log.d(Constants.LogTag.CLTV_TAG + TAG, "return instance mRatingSystems");
            ...
            try (XmlResourceParser parser =
                ...
                Log.d(Constants.LogTag.CLTV_TAG + TAG, "Parsing packageName:" + packageName+" curPackageName:"+curPackageName);

                ratingSystems = parse(parser, packageName, !info.isSystemDefined());
                Log.d(Constants.LogTag.CLTV_TAG + TAG, "Parsing ratingSystems:" + ratingSystems);
            }
    ...
    private List<ContentRatingSystem> parse(
        ...
        if(domain.equals("com.mediatek.dtv.tvinput.dvbtuner")) {
            domain = "com.mediatek.dtv";
        }
