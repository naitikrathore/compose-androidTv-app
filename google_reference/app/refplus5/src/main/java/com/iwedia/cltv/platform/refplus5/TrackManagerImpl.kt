...
//    <string-array name="audio_channels_strings">
            ...
            for (track in tracks) {
                if (track.type == TvTrackInfo.TYPE_AUDIO) {
                    if (isCurrentServiceAnalog()) {
                        var analogIndex = track.extra.getInt(com.mediatek.dtv.tvinput.framework.tifextapi.analog.trackinfo.lib.Constants.KEY_ATV_SOUND_MODE)
