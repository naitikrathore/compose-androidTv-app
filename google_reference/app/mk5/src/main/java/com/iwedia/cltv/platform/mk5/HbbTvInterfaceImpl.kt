...
class HbbTvInterfaceImpl(val context: Context?, val timeInterface: TimeInterface, private val utilsInterfaceImpl: UtilsInterfaceImpl) : HbbTvInterfaceBaseImpl(
    utilsInterfaceImpl
) {
    ...
    private val hbbTvSDKCallback = com.iwedia.cltv.platform.mk5.MtkTvCallback.getInstance()
    ...
    init {
        hbbTvSDKCallback.registerHbbTvHandleInterface(object : com.iwedia.cltv.platform.mk5.MtkTvCallback.HbbTvHandleInterface {
