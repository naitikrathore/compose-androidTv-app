...
import com.iwedia.cltv.platform.mk5.provider.PlatformSpecificData
...
internal class TvInterfaceImpl (
    ...
    private val mHandler: Handler = object : Handler(Looper.getMainLooper()) {
        override fun handleMessage(msg: Message) {
            ...
            when(msg.what) {
                ...
                com.iwedia.cltv.platform.mk5.TvCallbackConst.MSG_CB_CHANNEL_LIST_UPDATE,
                com.iwedia.cltv.platform.mk5.TvCallbackConst.MSG_CB_NFY_UPDATE_TV_PROVIDER_LIST-> {
                ...
                com.iwedia.cltv.platform.mk5.TvCallbackConst.MSG_CB_SVCTX_NOTIFY-> {
                    val currentMtkService =  MtkTvChannelListBase.getCurrentChannel()
                    if((msg.obj as com.iwedia.cltv.platform.mk5.TvCallbackData).param1 == MtkTvSvctxNotifyCode.SVCTX_NTFY_CODE_SERVICE_CHANGING) {
                    ...
                    } else if ((msg.obj as com.iwedia.cltv.platform.mk5.TvCallbackData).param1 == MtkTvSvctxNotifyCode.SVCTX_NTFY_CODE_NO_AUDIO_VIDEO_SVC ||
                        (msg.obj as com.iwedia.cltv.platform.mk5.TvCallbackData).param1 == MtkTvSvctxNotifyCode.SVCTX_NTFY_CODE_AUDIO_ONLY_SVC
                    ) {
                        InformationBus.informationBusEventListener?.submitEvent(
                            Events.NO_AV_OR_AUDIO_ONLY_CHANNEL,
                            arrayListOf((msg.obj as com.iwedia.cltv.platform.mk5.TvCallbackData).param1)
                        )
                        Log.e(com.iwedia.cltv.platform.model.Constants.LogTag.CLTV_TAG +TAG, "MSG_CB_SVCTX_NOTIFY is ${(msg.obj as com.iwedia.cltv.platform.mk5.TvCallbackData).param1} ")
                    }
                }
            }
        }
    ...
    init {
        com.iwedia.cltv.platform.mk5.TvCallbackHandler.getInstance()
            .addCallBackListener(com.iwedia.cltv.platform.mk5.TvCallbackConst.MSG_CB_CHANNEL_LIST_UPDATE, mHandler)

        com.iwedia.cltv.platform.mk5.TvCallbackHandler.getInstance()
            .addCallBackListener(com.iwedia.cltv.platform.mk5.TvCallbackConst.MSG_CB_NFY_UPDATE_TV_PROVIDER_LIST, mHandler)

        com.iwedia.cltv.platform.mk5.TvCallbackHandler.getInstance()
            .addCallBackListener(com.iwedia.cltv.platform.mk5.TvCallbackConst.MSG_CB_SVCTX_NOTIFY, mHandler)

        com.iwedia.cltv.platform.mk5.TvCallbackHandler.getInstance().addCallBackListener(com.iwedia.cltv.platform.mk5.TvCallbackConst.MSG_CB_SVCTX_NOTIFY,mHandler)
