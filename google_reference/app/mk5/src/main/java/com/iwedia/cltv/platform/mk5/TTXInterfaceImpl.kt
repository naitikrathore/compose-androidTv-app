...
class TTXInterfaceImpl(val utilsInterface: UtilsInterface) : TTXInterfaceBaseImpl(utilsInterface) {
    ...
    private val ttxSDKCallback = com.iwedia.cltv.platform.mk5.MtkTvCallback.getInstance()
    ...
    fun init()
    {
        ...
        ttxSDKCallback.registerTTXHandleInterface( object : com.iwedia.cltv.platform.mk5.MtkTvCallback.TtxTvHandleInterface {
