...
class Contract private constructor() {
    companion object {
        fun buildChannelsUri(id: Long) : Uri {
            return ContentUris.withAppendedId(ContentProvider.CHANNELS_URI, id)
        }

        fun buildConfigUri(id: Long) : Uri {
            return ContentUris.withAppendedId(ContentProvider.CONFIG_URI, id)
        }

        fun buildOemCustomizationUri(id: Long) : Uri {
            return ContentUris.withAppendedId(ContentProvider.OEM_CUSTOMIZATION_URI, id)
        }

        fun buildLanguagesUri(id: Long) : Uri {
            return ContentUris.withAppendedId(ContentProvider.LANGUAGES_URI, id)
        }

        fun buildScheduledRemindersUri(id: Long) : Uri {
            return ContentUris.withAppendedId(ContentProvider.SCHEDULED_REMINDERS_URI, id)
        }

        fun buildScheduledRecordingsUri(id: Long) : Uri {
            return ContentUris.withAppendedId(ContentProvider.SCHEDULED_RECORDINGS_URI, id)
        }

        fun buildFavoritesUri(id: Long) : Uri {
            return ContentUris.withAppendedId(ContentProvider.FAVORITES_URI, id)
        }

        fun buildConfigurableKeysUri(id: Long) : Uri {
            return ContentUris.withAppendedId(ContentProvider.CONFIGURABLE_KEYS_URI, id)
        }

        fun buildSystemInfoUri(id: Long) : Uri {
            return ContentUris.withAppendedId(ContentProvider.SYSTEM_INFO_URI, id)
        }

        fun buildPromoUri(id: Long) : Uri {
            return ContentUris.withAppendedId(PromoProvider.PROMO_URI, id)
        }
    }
    ...
    class OemCustomization private constructor(): BaseColumns {
        companion object {
            ...
            const val COLOR_DARK_COLUMN = "color_dark"
            const val COLOR_PREFERENCE_CHECKED = "color_preference_checked"
    ...
    class PromoBanner private constructor(): BaseColumns {
        companion object {
            /*Promotion Banner table columns*/
            const val CONTENT_TYPE = "vnd.android.cursor.dir/vnd.com.iwedia.cltv.platform.model.content_provider.promo_banner"
            const val CONTENT_ITEM_TYPE = "vnd.android.cursor.item/vnd.com.iwedia.cltv.platform.model.content_provider.promo_banner"
            const val SUPPORTED_COUNTRY_COLUMN = "supported_country"
        }
    }
}