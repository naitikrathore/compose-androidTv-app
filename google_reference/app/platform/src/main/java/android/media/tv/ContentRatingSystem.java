...
public class ContentRatingSystem {
    ...
    public static class Builder {
        ...
        public List<String> getmCountries() {
            return mCountries;
        }

        public List<Rating.Builder> getmRatingBuilders() {
            return mRatingBuilders;
        }

        public List<SubRating.Builder> getmSubRatingBuilders() {
            return mSubRatingBuilders;
        }

        public List<Order.Builder> getmOrderBuilders() {
            return mOrderBuilders;
        }
