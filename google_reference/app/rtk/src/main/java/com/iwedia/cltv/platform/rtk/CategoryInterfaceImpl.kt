...
internal class CategoryInterfaceImpl(
    ...
    /**
    * Following method uses *synchronized* block
    * there was issue that multiple method was calling
    * getAvailableFilters and causing race condition with @property [checkCount]
    * to avoid it we tried synchronized block
    */
                ...
                CoroutineHelper.runCoroutine({
                    refreshChannels(object : IAsyncCallback {
                        ...
                        override fun onSuccess() {
                            ...
                            checkForChannelCategories(object :
    ...
    /**
     * Even after using synchronised above method
     * we shifted @param [checkCount] above Collections.sort
     * as it was taking more time to execute.
     */
