...
import com.iwedia.cltv.platform.R
...
open class GeneralConfigInterfaceBaseImpl(private var context: Context,private var utilsInterface: UtilsInterface): GeneralConfigInterface {

    protected var virtual_rcu : Boolean = false
    private var vertical_epg : Boolean = false
    private var epgCellMerge : Boolean = false
    protected var pvr : Boolean = false
    protected var timeshift : Boolean = false
    protected var hbbtv : Boolean = true
    protected var ttx : Boolean = true
    protected var ci : Boolean = true
    protected var blue_mute : Boolean = true
    protected var oad : Boolean = true
    ...
    protected var teletext_enable_column: Boolean = false
    ...
    private fun readFromJson(name: String): Int {
        val iS = context.classLoader.getResourceAsStream(utilsInterface.jsonPath)
