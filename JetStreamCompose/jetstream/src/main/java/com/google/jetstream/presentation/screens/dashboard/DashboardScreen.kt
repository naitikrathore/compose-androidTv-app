...
fun DashboardScreen(
    ...
    BackPressHandledArea(
        ...
        DashboardTopBar(
            ...
            Log.e("Dasyyy","DashScrNavi")
            navController.navigate(screen()) {
                Log.e("Naitik","DScreen")
...
private fun Body(
    ...
    NavHost(
        ...
        composable(Screens.Categories()) {
            Log.e("Dasyyy","DashScrBodyHomeCat")
            CategoriesScreen(
